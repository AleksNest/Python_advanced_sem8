...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Seminar8'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Алексей\Desktop\GreekBrains\ДОМАШКА\Python_advanced\Seminar8\Scripts\deactivate.nu'
