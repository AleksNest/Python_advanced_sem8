...
def directory_reference(directory: Path):
    ...
    with (open('result.json', 'w') as f_json,
        ...
        for dir_path, dir_name, file_name in os.walk(directory):
            ...
            for dir in dir_name:
                ...
                data[dir_path].update({dir: {'object_size': size, 'object_type': 'directory',
            ...
            for i in file_name:
                ...
                data[dir_path].update(
                    {i: {'object_size': size, 'object_type': 'file', 'parant_directory': dir_path.split('\\')[-1]}})
    ...
    print(f'созданы справочники  result.json, result.csv, result.pickle')
